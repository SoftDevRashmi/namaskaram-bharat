...
const Card: React.FC<CardProps> = ({ card, onClick, className }) => {
  return (
    <div
      ...
      style={{ width: '250px', height: '150px', marginLeft: 'auto',
        marginRight: 'auto', // 💥 THIS LINE centers each card in its grid cell
       }}
    >
      <img src={card.img} alt={card.title} className="w-full h-full object-cover rounded-lg group-hover:brightness-90 transition duration-300 font-bold text-sm sm:text-base md:text-lg" />
