...
const SecondPage: React.FC<SecondPageProps> = ({ card, onBack }) => {
  ...
  return (
    ...
    >
      {/* Breadcrumbs */}
      <nav style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '1rem 2rem 0 2rem', fontSize: 16, color: '#e0f2fe', fontWeight: 500 }}>
        <span style={{ cursor: 'pointer', color: '#14b8a6' }} onClick={() => router.push('/')}>Home</span>
        <span style={{ color: '#38bdf8', fontWeight: 700 }}>&gt;</span>
        <span style={{ color: '#fff', opacity: 0.92 }}>Our Services</span>
      </nav>
