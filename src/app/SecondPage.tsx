...
const SecondPage: React.FC<SecondPageProps> = ({ card, onBack }) => {
  ...
  <div className="flex flex-col items-center">
    ...
    <div className="mt-4 flex justify-center">
      ...
      {/* Footer Section */}
      <footer className="bg-teal-800 text-white pt-3 md:pt-12 pb-2 md:pb-4 px-4 mt-8 border-t border-teal-700">
          ...
          <div className="hidden md:flex md:flex-row justify-between gap-8">
            ...
            <div className="flex-1 min-w-[220px] mb-8 md:mb-0">
              <div className="flex items-center mb-4">
                <img src="/images/logo2.png" alt="Namaskaram Bharat" className="h-10 mr-3" />
